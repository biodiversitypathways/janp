...
plot_RDA <- ggplot(data = t3scores, aes(x = RDA1, y = RDA2)) +
  ...
  geom_text(data = t3vect, aes(x = RDA1, y = RDA2, label = rownames(t3vect)), 
            size = 3, colour = "black", fontface = "italic", nudge_x = 0.1, nudge_y = 0.1) +
  theme_bw() +
...
Here are species guilds @tbl-guilds and see @fig-spp-activity-nesting and @fig-spp-activity-dietary by nesting and dietary guilds.
