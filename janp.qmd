...
<figure>
  <div style="display:flex; gap:10px;">
    <img src="assets/tekarra9-2024.png" style="width:48%;" />
    <img src="assets/tekarra9-2025.png" style="width:48%;" />
  </div>
  <figcaption><strong>Figure X.</strong> Tekarra 9 camera views from 2024 (A) and 2025 (B).</figcaption>
</figure>
...
trend_table <- trendz %>%
  ...
  unnest() %>%
  mutate(
    across(where(is.numeric), ~ round(.x, 2))  # rounds all numeric columns to 2 decimals
  )
