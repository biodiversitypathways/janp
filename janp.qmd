...
Single-species trends, and their underlying coefficients with 95% CIs can be found in tabset in @fig-trend-points and @tbl-trend. The full outline of declines over the entire period can be seen in @fig-trend-vert.
...
Trends grouped by guild can be found at @fig-trend-guilds-mig, @fig-trend-guilds-hab, and @fig-trend-guilds-trait. 
...
#| fig-cap: Summary of trend of feeding trait guilds
