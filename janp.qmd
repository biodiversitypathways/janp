...
ggplot(yearly_rao, aes(x = year, y = meanRao)) +
  geom_point(color = "blue", size = 2) +  # Points for yearly Rao
  geom_line(aes(y = lm_fit), color = "red", size = 1.2, linetype = "dashed") +  # Linear trend
  geom_line(aes(y = mix_fit), color = "purple", size = 1.2, linetype = "dotted") +  # Mixed-effects trend
  geom_line(aes(y = seg_fit), color = "green", size = 1.2) +  # Segmented trend
  labs(
